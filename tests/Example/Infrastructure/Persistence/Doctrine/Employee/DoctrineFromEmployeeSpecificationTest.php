...
class DoctrineFromEmployeeSpecificationTest extends TestCase
{
    /** @var DoctrineEmployeeSpecification */
    ...
    {
        $this->specification = new DoctrineFromEmployeeSpecification(new \DateTimeImmutable('-1 year'));
