...
class OrSpecificationTest extends TestCase
{
    ...
    public function it_should_create_and_query_sql_from_simple_query_builder()
    {
        ...
        $this->specification = new OrSpecification($mock, $mock);
        ...
        $expected = 'SELECT e0_.id AS id_0, e0_.name AS name_1, e0_.created_at AS created_at_2 FROM employees e0_ WHERE e0_.id < 4 OR e0_.id < 4';
        ...
        $expected = 'SELECT e0_.id AS id_0, e0_.name AS name_1, e0_.created_at AS created_at_2 FROM employees e0_ WHERE (e0_.id >= 4 AND e0_.name NOT LIKE ?) OR (e0_.id >= 4 AND e0_.name NOT LIKE ?)';
        ...
        $expected = 'SELECT e0_.id AS id_0, e0_.name AS name_1, e0_.created_at AS created_at_2 FROM employees e0_ WHERE ((e0_.id >= 4 AND e0_.name NOT LIKE ?) AND e0_.created_at IS NULL) OR ((e0_.id >= 4 AND e0_.name NOT LIKE ?) AND e0_.created_at IS NULL)';
        ...
        $expected = 'SELECT e0_.id AS id_0, e0_.name AS name_1, e0_.created_at AS created_at_2 FROM employees e0_ WHERE ((e0_.id >= 4 OR e0_.name NOT LIKE ?) OR e0_.created_at IS NOT NULL) OR ((e0_.id >= 4 OR e0_.name NOT LIKE ?) OR e0_.created_at IS NOT NULL)';
    ...
    public function it_should_create_not_query_sql_from_simple_query_builder_using_dbal()
    {
        ...
        $expected = 'SELECT e.id, e.name, e.created_at FROM employees e WHERE (e.id < 4) OR (e.id < 4)';
        $actual = $this->specification->modifyQuery($test1);
        ...
        $expected = 'SELECT e.id, e.name, e.created_at FROM employees e WHERE ((e.id >= 4) AND (e.name NOT LIKE :name)) OR ((e.id >= 4) AND (e.name NOT LIKE :name))';
        $actual = $this->specification->modifyQuery($test2);
        $this->assertSame($expected, $actual->getSQL());
        ...
        $expected = 'SELECT e.id, e.name, e.created_at FROM employees e WHERE (((e.id >= 4) AND (e.name NOT LIKE :name)) AND (e.created_at IS NULL)) OR (((e.id >= 4) AND (e.name NOT LIKE :name)) AND (e.created_at IS NULL))';
        $actual = $this->specification->modifyQuery($test3);
        $this->assertSame($expected, $actual->getSQL());
        ...
        $expected = 'SELECT e.id, e.name, e.created_at FROM employees e WHERE (((e.id >= 4) OR (e.name NOT LIKE :name)) OR (e.created_at IS NOT NULL)) OR (((e.id >= 4) OR (e.name NOT LIKE :name)) OR (e.created_at IS NOT NULL))';
        $actual = $this->specification->modifyQuery($test4);
        $this->assertSame($expected, $actual->getSQL());
    }
